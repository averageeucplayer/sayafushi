...
#[command]
pub fn load(asset_preloader: State<AssetPreloader>, update_manager: State<UpdateManager>) -> Result<LoadResult, AppError> {
    asset_preloader.wait().expect("could not load assets");
